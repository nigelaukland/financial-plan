...
export default function FinancialPlan() {
  ...
  const defaultCategories = () => [
    ...
    { id: "steady", name: "Steady", type: "expense", items: [
      ...
      { id: "childcare", label: "Childcare", planned: 400 },
      { id: "subs", label: "Subscriptions & streaming", planned: 45 },
      { id: "homeinsurance", label: "Home & contents insurance", planned: 45 },
      { id: "eatingout", label: "Eating out & takeaway", planned: 150 },
    ]},
    { id: "lumpy", name: "Lumpy", type: "expense", items: [
      { id: "holidays", label: "Holidays", planned: 250 },
      { id: "homeimprovements", label: "Home improvements", planned: 150 },
      { id: "carmaintenance", label: "Car maintenance & MOT", planned: 60 },
      { id: "clothing", label: "Clothing", planned: 90 },
      { id: "gifts", label: "Gifts", planned: 40 },
      { id: "christmas", label: "Christmas", planned: 60 },
      { id: "annualinsurance", label: "Annual insurance renewals", planned: 35 },
      { id: "medicaldental", label: "Medical & dental", planned: 30 },
      { id: "hobbies", label: "Hobbies & other leisure", planned: 100 },
      { id: "bigticket", label: "Big-ticket purchases", planned: 80 },
    ]},
