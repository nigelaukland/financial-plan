...
export default function FinancialPlan() {
  ...
  const defaultCategories = () => [
    ...
    { id: "steady", name: "Steady", type: "expense", items: [
      { id: "mortgage", label: "Mortgage", planned: 1942.95 },
      { id: "groceries", label: "Groceries", planned: 1195.10 },
      { id: "kidsfamily", label: "Kids & Family Activities", planned: 1043.11 },
      { id: "dining", label: "Dining, Cafes & Takeaway", planned: 849.73 },
      { id: "shopping", label: "Shopping – General/Online", planned: 608.46 },
      { id: "energywater", label: "Energy & Water", planned: 348.90 },
      { id: "housecleaning", label: "House Cleaning", planned: 346.67 },
      { id: "counciltax", label: "Council Tax", planned: 335.96 },
      { id: "transport", label: "Transport – Rail/Bus/Air", planned: 324.08 },
      { id: "vehicle", label: "Vehicle – Fuel, Parking & Maintenance", planned: 321.18 },
      { id: "health", label: "Health & Pharmacy", planned: 228.53 },
      { id: "sportsleisure", label: "Sports, Leisure & Entertainment", planned: 207.11 },
      { id: "pets", label: "Pets", planned: 104.65 },
      { id: "personalcare", label: "Personal Care", planned: 88.59 },
      { id: "alcohol", label: "Alcohol & Wine", planned: 85.53 },
      { id: "mobilebroadband", label: "Mobile & Broadband", planned: 82.34 },
      { id: "cloudsoftware", label: "Cloud/Software Subscriptions", planned: 71.34 },
      { id: "lifeinsurance", label: "Life Insurance", planned: 68.20 },
      { id: "tvstreaming", label: "TV & Streaming Subscriptions", planned: 62.62 },
      { id: "leisurefitness", label: "Leisure & Fitness (regular)", planned: 25.42 },
      { id: "booksmedia", label: "Books & Media", planned: 23.16 },
      { id: "bankfees", label: "Bank/Card Fees (monthly)", planned: 18.13 },
    ]},
    { id: "lumpy", name: "Lumpy", type: "expense", items: [
      { id: "travelholidays", label: "Travel & Holidays", planned: 1928.02 },
      { id: "sophiesschool", label: "Sophie's School (Kingston Grammar)", planned: 968.42 },
      { id: "otheruncategorized", label: "Other / Uncategorized", planned: 608.75 },
      { id: "homerenovation", label: "Home Renovation", planned: 465.33 },
      { id: "homegarden", label: "Home & Garden / DIY", planned: 267.85 },
      { id: "clothingsportswear", label: "Clothing & Sportswear", planned: 205.03 },
      { id: "personaltransfers", label: "Personal Transfers / Unclear (Nigel)", planned: 155.08 },
      { id: "entertainmentevents", label: "Entertainment & Events (occasional)", planned: 146.83 },
      { id: "otherinsurance", label: "Other Insurance (annual renewals)", planned: 105.71 },
      { id: "gifts", label: "Gifts", planned: 31.37 },
      { id: "cardannualfee", label: "Card Annual Fee", planned: 25.00 },
    ]},
    { id: "saving", name: "Saving & Investments", type: "expense", items: [
      { id: "savingsinvestments", label: "Savings & Investments", planned: 988.67 },
    ]},
  ];
